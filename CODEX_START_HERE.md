...
- `run_kr_theme_projection.py`는 input ledger·SQLite sidecar와 KR JSONL/report output 충돌을 ledger open 전 차단하고, committed keyword projection outbox와 한국어 요약을 mode `600`으로 유지. provider·LLM·broker·TradeSignal·국내 주문 호출 없음
