...
2. 실제 read-only stream smoke에서 disconnect/reconnect 또는 provider rejection이 관측되면 구현된 epoch history·failed attempt와 private evidence를 대사한다. production smoke에 bounded supervisor를 연결하기 전 fixture의 3회 budget보다 넓히지 않는다.
