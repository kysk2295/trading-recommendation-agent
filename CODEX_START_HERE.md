...
2. live child의 aggregate success/replay/blocked 결과를 별도 supervisor attempt 감사 계약에 결합해 fleet READY와 microstructure actionability 상태를 독립적으로 조회한다. child 실패를 fleet minute-bar 성공으로 덮지 않고 이미 저장된 raw receipt도 삭제하지 않는다.
