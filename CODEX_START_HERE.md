...
2. 실제 장중 smoke 뒤 live child audit과 raw receipt/actionability store를 대사하는 query-only 운영 요약 CLI를 추가한다. child 실패를 fleet minute-bar 성공으로 덮지 않고 이미 저장된 raw receipt도 삭제하지 않는다.
