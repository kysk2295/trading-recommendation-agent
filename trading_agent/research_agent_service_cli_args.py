...
_SYSTEMATIC_PATH_OPTIONS = (
    ...
    "systematic-input-csv",
    "systematic-foundation-manifest",
...
def config_from_provision_args(args: argparse.Namespace) -> ResearchAgentServiceConfig:
    ...
    systematic = SystematicResearchActionConfig(
        ...
        input_csv=_absolute(args.systematic_input_csv),
        data_foundation_manifest=_absolute(args.systematic_foundation_manifest),
