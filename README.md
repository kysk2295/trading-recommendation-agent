...
상태 이벤트는 결정일보다 뒤의 첫 NYSE 정규 세션부터 유효하다. 현재 구현은 등록·해시 체인·날짜 기준 projection까지이며 Reviewer evidence를 검증해 transition을 append하는 Lifecycle Controller와 champion 자동 선언은 아직 닫혀 있다.
