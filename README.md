...
- 목표 Data Plane은 아직 구현되지 않았다. 전 종목 상시 raw stream, object-storage/Parquet catalog, security master, data capability registry와 deterministic cross-source replay가 없다.
