...
- lane manifest·binding·experiment scope·daily snapshot registry와 ORB intraday final snapshot producer는 구현됐지만 독립 Reviewer의 승격 event projection과 Portfolio Manager는 아직 없다. Portfolio Manager는 최소 두 lane champion 전에는 구현하거나 주문권한을 갖지 않는다.
