...
- SEC EDGAR submissions의 recent와 manifest-bound bounded additional-history raw-first vertical은 구현됐지만 filing document 본문, 회사 발표와 SEC capability registry projection은 아직 없다. 실제 연락처 User-Agent를 임의 생성하지 않아 production SEC GET은 수행하지 않았다.
