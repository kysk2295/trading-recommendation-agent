# 스무 번째 Alpaca Paper smoke 시도 체크포인트

작성 시각: 2026-08-20 09:41 EDT / 2026-08-20 22:41 KST
판정: **SAFE SKIP / STAGE 1 BLOCKED**

## 결론

`feature/paper-account-activities`의 local/remote 최신 `fd1dbc3`에서 단계 1을 스무 번째로 시도했다. 사용자 지정 기준 `7b033f3`은 이 commit의 ancestor다.
...
- broker CLI 최대 RSS는 57,671,680 bytes, 전체 검증 최대 RSS는 639,467,520 bytes, 측정 swap은 0이었다.
