...
다음 M5 경계는 이 source의 실제 coverage와 health를 canonical capability registry에 투영하는 것이다. 그 뒤 filing document 본문과 issuer/company-announcement evidence를 별도 bounded source로 추가한다.
