# 스물세 번째 Alpaca Paper smoke 시도 체크포인트

작성 시각: 2026-08-25 09:43 EDT / 2026-08-25 22:43 KST
판정: **SAFE SKIP / STAGE 1 BLOCKED**

## 결론

`feature/paper-account-activities`의 local/remote 최신 `5870350`에서 단계 1을 스물세 번째로 시도했다. 사용자 지정 기준 `7b033f3`은 이 commit의 ancestor다.
...
- broker CLI 최대 RSS는 58,540,032 bytes, 전체 검증 최대 RSS는 641,171,456 bytes였고 측정 swap은 0이었다.
