...
- focused open-smoke/session/query-only: `59 passed in 6.13s`
- related KR theme/same-cycle: `283 passed, 2564 deselected in 16.76s`
- full suite: `2847 passed in 147.57s`
