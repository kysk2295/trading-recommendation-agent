...
- focused open-smoke/session/query-only: `55 passed in 6.55s`
- related KR theme/same-cycle: `279 passed, 2564 deselected in 17.07s`
- full suite: `2843 passed in 151.21s`
