# 서른여섯 번째 Alpaca Paper smoke 시도 체크포인트

작성 시각: 2026-09-16 11:09~11:10 EDT / 2026-09-17 00:09~00:10 KST
판정: **SAFE SKIP / STAGE 1 BLOCKED**

## 결론

`feature/paper-account-activities`의 clean local/remote `e0d6171`에서 Stage 1을 서른여섯 번째로 시도했다. 사용자 지정 기준 `7b033f3`은 이 commit의 ancestor다.
...
- broker CLI 최대 RSS: 58,425,344 bytes, 각 process swap 0
- Alpaca CLI·KIS ORB watch·전체시장 백테스트 중복: 0개
- 코드 변경: 없음
- 전체 pytest·Ruff·basedpyright: 코드 변경이 없어 재실행하지 않음
- `graphify query`: 설치된 실행기의 삭제된 Python 3.12 경로 때문에 시작 전 실패
