...
- 각 source-backed selection은 exact data foundation SHA-256을 사전등록한다.
- foundation의 `us_equities/day_trading/<strategy>` lane, `historical_research`, `minute_bar`, entitlement, 역사 시작일, 완전성과 freshness가 모두 `READY`여야 한다.
- foundation hash는 historical trial의 append-only `evidence_budget`에도 기록한다.
...
- data foundation 누락 또는 다른 strategy foundation: version/trial 신규 `0/0`, blocked
...
- source-backed/queue/ledger/reviewer/data-foundation focused: `105 passed`
- full pytest: `3390 passed`
- Ruff: pass
