...
| G006 / M4 | US·KR 5-session always-on soak 및 재부팅 복구 | **waiting** | 준비된 US `2026-07-30` 및 KR `2026-07-31` one-shot job에는 current-main/expiry-bound `RunAtLoad` 재부팅 복구 plist가 마련됐다. 실제 재부팅은 관찰되지 않았고, 향후 거래소 캘린더 세션 자동 생성이 없으며, US/KR 5-session report도 없다 | `outputs/acceptance/soak/us_five_session_report.json`, `kr_five_session_report.json`, `restart_and_provider_fault_reconciliation.json`; 재부팅 1회·read-only provider 장애 후 중복·누락 0 |
