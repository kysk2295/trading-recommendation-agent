...
- [x] **Step 3: Add the minimum date-bound resume contract**
...
- [x] **Step 3: Implement exact sequential finalization**
...
- Create: `tests/fixtures/kr_same_cycle/opendart/fixture-manifest.json`
- Create: `tests/fixtures/kr_same_cycle/opendart/page-1.json`
- Create: `tests/fixtures/kr_same_cycle/ls_nws/fixture-manifest.json`
- Create: `tests/fixtures/kr_same_cycle/kis_kr_ranking/fixture-manifest.json`
...
- [x] **Step 3: Implement the bounded CLI**
...
- [x] **Step 4: Verify CLI and static gates**
...
```bash
git add run_kr_same_cycle_collect.py tests/test_kr_same_cycle_collect_cli.py tests/fixtures/kr_same_cycle
...
- [x] **Step 1: Document usage and boundary**
...
- [x] **Step 4: Record the checkpoint and mark plan items**
